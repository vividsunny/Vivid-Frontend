        ...
        <section className="expertise-section p-70">
            <div className="container">
                ...
                <div className="expertise-list">
                    <ul>
                        <li data-aos="fade-up" data-aos-duration="1100" data-aos-delay="100">
                            <div className="expertise-box">
                                <img src={require('../images/shopify.png').default} alt="VIVID WEB SOLUTION" />
                            </div>
                        </li>
                        <li data-aos="fade-up" data-aos-duration="1100" data-aos-delay="200">
                            <div className="expertise-box">
                        ...
                        <li data-aos="fade-up" data-aos-duration="1100" data-aos-delay="400">
                            <div className="expertise-box">
                                <img src={require('../images/nodejs.png').default} alt="VIVID WEB SOLUTION" />
                            </div>
                        </li>
                        <li data-aos="fade-up" data-aos-duration="1100" data-aos-delay="500">
                            <div className="expertise-box">
                                <img src={require('../images/reactjs.png').default} alt="VIVID WEB SOLUTION" />
                            </div>
                        </li>
                        <li data-aos="fade-up" data-aos-duration="1100" data-aos-delay="600">
                            <div className="expertise-box">
                                <img src={require('../images/laravel.png').default} alt="VIVID WEB SOLUTION" />
                            </div>
                        </li>
                        <li data-aos="fade-up" data-aos-duration="1100" data-aos-delay="700">
                            <div className="expertise-box">
                                <img src={require('../images/php.png').default} alt="VIVID WEB SOLUTION" />
                            </div>
                        </li>
                        <li data-aos="fade-up" data-aos-duration="1100" data-aos-delay="800">
                            <div className="expertise-box">
                                <img src={require('../images/htmlcssjs.png').default} alt="VIVID WEB SOLUTION" />
                            </div>
                        </li>
                        <li data-aos="fade-up" data-aos-duration="1100" data-aos-delay="900">
                            <div className="expertise-box">
